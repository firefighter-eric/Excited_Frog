...
if(((((cljs.core.set_QMARK_.call(null,class$)) || (cljs.core.sequential_QMARK_.call(null,class$)))) && (cljs.core.every_QMARK_.call(null,(function (p1__25126_SHARP_){
return (((p1__25126_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__25126_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.call(null,G__25127,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__25127;
}
});
...
var len__4517__auto___25130 = arguments.length;
var i__4518__auto___25131 = (0);
while(true){
if((i__4518__auto___25131 < len__4517__auto___25130)){
args__4520__auto__.push((arguments[i__4518__auto___25131]));

var G__25132 = (i__4518__auto___25131 + (1));
i__4518__auto___25131 = G__25132;
continue;
} else {
}
break;
...
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__4521__auto__);
});
...
var G__25129 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__25129,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1);
} else {
return G__25129;
}
});
...
/** @this {Function} */
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq25128){
var self__4505__auto__ = this;
return self__4505__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq25128));
});
...
var vec__25135 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__25135,(0),null);
var names = cljs.core.nth.call(null,vec__25135,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__25135,tag_name,names){
return (function (p1__25133_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__25133_SHARP_));
});})(matches,vec__25135,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__25135,tag_name,names){
return (function (p1__25134_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__25134_SHARP_));
});})(matches,vec__25135,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__25138){
...
var tag = first__25141;
var content = seq__25140__$1;
...
var vec__25142 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__25142,(0),null);
var id = cljs.core.nth.call(null,vec__25142,(1),null);
var class$ = cljs.core.nth.call(null,vec__25142,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1573409127333
