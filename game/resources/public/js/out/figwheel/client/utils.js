...
var or__3936__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj27466 = {"detail":data};
return obj27466;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__3925__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__3925__auto__)){
var and__3925__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__27473 = cljs.core._EQ_;
var expr__27474 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__27473.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__27474))){
return ((function (pred__27473,expr__27474){
return (function (p1__27467_SHARP_){
return console.warn(p1__27467_SHARP_);
});
;})(pred__27473,expr__27474))
} else {
if(cljs.core.truth_(pred__27473.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__27474))){
return ((function (pred__27473,expr__27474){
return (function (p1__27468_SHARP_){
return console.debug(p1__27468_SHARP_);
});
;})(pred__27473,expr__27474))
} else {
if(cljs.core.truth_(pred__27473.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__27474))){
return ((function (pred__27473,expr__27474){
return (function (p1__27469_SHARP_){
return console.error(p1__27469_SHARP_);
});
;})(pred__27473,expr__27474))
} else {
return ((function (pred__27473,expr__27474){
return (function (p1__27470_SHARP_){
return console.log(p1__27470_SHARP_);
});
;})(pred__27473,expr__27474))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__27477){
...
var opts = map__27478__$1;
var eval_fn = cljs.core.get.call(null,map__27478__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__27480_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__27482,(0),null);
var v = cljs.core.nth.call(null,vec__27482,(1),null);
...
if(cljs.core.truth_((function (){var and__3925__auto__ = (((typeof localStorage !== 'undefined')) && (!((goog.object.get(localStorage,"getItem") == null))));
...
}catch (e27487){if((e27487 instanceof Error)){
var e = e27487;
return not_found;
} else {
throw e27487;
...
//# sourceMappingURL=utils.js.map?rel=1573409130508
