...
var G__27147 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__27147;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__27148 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__27148,ch);
...
if(("\\" === ch__$1)){
var ch_27149__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_27149__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_27149__$2);
} else {
}

var G__27150 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__27150;
continue;
}
}
...
if(cljs.core.truth_((function (){var or__3936__auto__ = cljs.tools.reader.impl.utils.whitespace_QMARK_.call(null,ch);
if(or__3936__auto__){
return or__3936__auto__;
} else {
var or__3936__auto____$1 = cljs.tools.reader.macros.call(null,ch);
...
var vec__27158 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27158,(0),null);
var start_column = cljs.core.nth.call(null,vec__27158,(1),null);
...
var G__27161 = cljs.core.conj_BANG_.call(null,a,form);
a = G__27161;
continue;
}
}
...
var _STAR_read_delim_STAR_27162 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_27162;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__27163 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27163,(0),null);
var start_column = cljs.core.nth.call(null,vec__27163,(1),null);
...
var vec__27166 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27166,(0),null);
var end_column = cljs.core.nth.call(null,vec__27166,(1),null);
...
var vec__27169 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27169,(0),null);
var start_column = cljs.core.nth.call(null,vec__27169,(1),null);
...
var vec__27172 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27172,(0),null);
var end_column = cljs.core.nth.call(null,vec__27172,(1),null);
...
var vec__27175 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27175,(0),null);
var start_column = cljs.core.nth.call(null,vec__27175,(1),null);
...
var vec__27178 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27178,(0),null);
var end_column = cljs.core.nth.call(null,vec__27178,(1),null);
...
var sb = (function (){var G__27181 = (new goog.string.StringBuffer());
G__27181.append(initch);
...
var or__3936__auto__ = cljs.tools.reader.impl.commons.match_number.call(null,s);
...
var G__27183 = (function (){var G__27182 = sb;
G__27182.append(ch);

return G__27182;
})();
var G__27184 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__27183;
ch = G__27184;
continue;
}
...
switch (G__27187) {
case "\\":
var G__27191 = (function (){var G__27188 = sb;
G__27188.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__27188;
})();
var G__27192 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__27191;
ch = G__27192;
continue;
...
break;
default:
var G__27193 = (function (){var G__27189 = sb;
G__27189.append(ch);

return G__27189;
})();
var G__27194 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__27193;
ch = G__27194;
continue;
...
var vec__27195 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27195,(0),null);
var end_column = cljs.core.nth.call(null,vec__27195,(1),null);
...
var vec__27198 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__27198,(0),null);
var column = cljs.core.nth.call(null,vec__27198,(1),null);
...
var or__3936__auto__ = cljs.tools.reader.resolve_alias.call(null,sym);
if(cljs.core.truth_(or__3936__auto__)){
return or__3936__auto__;
} else {
...
var vec__27203 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__27203,(0),null);
var column = cljs.core.nth.call(null,vec__27203,(1),null);
...
var m__$1 = (cljs.core.truth_((function (){var and__3925__auto__ = line;
...
var vec__27208 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__27208,(0),null);
var column = cljs.core.nth.call(null,vec__27208,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__27213 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__27213,(0),null);
var start_column = cljs.core.nth.call(null,vec__27213,(1),null);
...
var vec__27216 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__27216,(0),null);
var end_column = cljs.core.nth.call(null,vec__27216,(1),null);
...
var G__27219 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__27219,true,null,opts,pending_forms);
...
var G__27220 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__27220)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__27220)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__27220)){
...
if((form === cljs.tools.reader.READ_EOF)){
return cljs.tools.reader.impl.errors.throw_eof_error.call(null,rdr,(function (){var and__3925__auto__ = (first_line < (0));
...
var _STAR_suppress_read_STAR_27221 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_27221;
}});
...
var G__27222 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__27222,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__27222,rdr,first_line);

return G__27222;
} else {
var or__3936__auto__ = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
if(cljs.core.truth_(or__3936__auto__)){
return or__3936__auto__;
} else {
...
var G__27226 = matched;
var G__27227 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__27226;
finished = G__27227;
continue;
} else {
...
if(cljs.core.not.call(null,(function (){var and__3925__auto__ = opts;
if(cljs.core.truth_(and__3925__auto__)){
...
var _STAR_suppress_read_STAR_27228 = cljs.tools.reader._STAR_suppress_read_STAR_;
cljs.tools.reader._STAR_suppress_read_STAR_ = (function (){var or__3936__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__3936__auto__)){
return or__3936__auto__;
} else {
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_27228;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env27229 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__27230 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__27230,"(");
...
var G__27231 = (i + (1));
var G__27232 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3936__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3936__auto__)){
return or__3936__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env27229;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__27233 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__27233);
...
var G__27234 = cljs.core.next.call(null,s__$1);
var G__27235 = ret;
s__$1 = G__27234;
r = G__27235;
continue;
...
var G__27236 = cljs.core.next.call(null,s);
var G__27237 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__27236;
key_vals = G__27237;
continue;
} else {
...
var or__3936__auto__ = cljs.core.get.call(null,cljs.tools.reader.gensym_env,sym);
if(cljs.core.truth_(or__3936__auto__)){
return or__3936__auto__;
} else {
...
if((function (){var and__3925__auto__ = ((!((form == null)))?(((((form.cljs$lang$protocol_mask$partition0$ & (262144))) || ((cljs.core.PROTOCOL_SENTINEL === form.cljs$core$IWithMeta$))))?true:false):false);
if(and__3925__auto__){
...
return cljs.tools.reader.add_meta.call(null,form,((cljs.core.special_symbol_QMARK_.call(null,form))?(new cljs.core.List(null,new cljs.core.Symbol(null,"quote","quote",1377916282,null),(new cljs.core.List(null,form,null,(1),null)),(2),null)):(((form instanceof cljs.core.Symbol))?(new cljs.core.List(null,new cljs.core.Symbol(null,"quote","quote",1377916282,null),(new cljs.core.List(null,(cljs.core.truth_((function (){var and__3925__auto__ = cljs.core.not.call(null,cljs.core.namespace.call(null,form));
if(and__3925__auto__){
...
))))):(cljs.core.truth_((function (){var or__3936__auto__ = (form instanceof cljs.core.Keyword);
if(or__3936__auto__){
return or__3936__auto__;
} else {
var or__3936__auto____$1 = typeof form === 'number';
if(or__3936__auto____$1){
return or__3936__auto____$1;
} else {
var or__3936__auto____$2 = typeof form === 'string';
if(or__3936__auto____$2){
return or__3936__auto____$2;
} else {
var or__3936__auto____$3 = (form == null);
if(or__3936__auto____$3){
return or__3936__auto____$3;
} else {
var or__3936__auto____$4 = cljs.tools.reader.bool_QMARK_.call(null,form);
if(cljs.core.truth_(or__3936__auto____$4)){
return or__3936__auto____$4;
} else {
...
var gensym_env27241 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env27241;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__27242 = token;
var G__27242__$1 = (((G__27242 == null))?null:cljs.core.subs.call(null,G__27242,(1)));
var G__27242__$2 = (((G__27242__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__27242__$1));
var G__27242__$3 = (((G__27242__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__27242__$2));
var G__27242__$4 = (((G__27242__$3 == null))?null:cljs.core.symbol.call(null,G__27242__$3));
if((G__27242__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__27242__$4);
}
})():(function (){var G__27243 = token;
var G__27243__$1 = (((G__27243 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__27243));
if((G__27243__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__27243__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
var temp__5455__auto__ = (function (){var or__3936__auto__ = cljs.tools.reader._STAR_data_readers_STAR_.call(null,tag);
if(cljs.core.truth_(or__3936__auto__)){
return or__3936__auto__;
} else {
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__27254,reader){
...
var eof = cljs.core.get.call(null,map__27255__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
if(cljs.core.truth_((function (){var and__3925__auto__ = s;
if(cljs.core.truth_(and__3925__auto__)){
return !((s === ""));
} else {
return and__3925__auto__;
...
var len__4517__auto___27263 = arguments.length;
var i__4518__auto___27264 = (0);
while(true){
if((i__4518__auto___27264 < len__4517__auto___27263)){
args__4520__auto__.push((arguments[i__4518__auto___27264]));

var G__27265 = (i__4518__auto___27264 + (1));
i__4518__auto___27264 = G__27265;
continue;
} else {
}
break;
...
return cljs.tools.reader.read_PLUS_string.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__4521__auto__);
});
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq27261){
...
return self__4504__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27262,seq27261__$1);
});


//# sourceMappingURL=reader.js.map?rel=1573409130150
